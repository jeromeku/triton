...
// launcher for: matmul_1x1x1x16x16x16_warps1xstages3
CUresult matmul_83ba3f02_0d1d2d3de4de5de6de7c8de9c10de11c(CUstream stream, CUdeviceptr C, CUdeviceptr A, CUdeviceptr B, int32_t M, int32_t N, int32_t K, int32_t stride_cm, int32_t stride_am, int32_t stride_bk);

CUresult matmul_1x1x1x16x16x16_warps1xstages3(CUstream stream, CUdeviceptr C, CUdeviceptr A, CUdeviceptr B, int32_t M, int32_t N, int32_t K, int32_t stride_cm, int32_t stride_cn, int32_t stride_am, int32_t stride_ak, int32_t stride_bk, int32_t stride_bn){
  if ((C % 16 == 0) && (A % 16 == 0) && (B % 16 == 0) && (M % 16 == 0) && (N % 16 == 0) && (K % 16 == 0) && (stride_cm % 16 == 0) && (stride_cn == 1) && (stride_am % 16 == 0) && (stride_ak == 1) && (stride_bk % 16 == 0) && (stride_bn == 1))
    return matmul_83ba3f02_0d1d2d3de4de5de6de7c8de9c10de11c(stream, C, A, B, M, N, K, stride_cm, stride_am, stride_bk);

  return CUDA_ERROR_INVALID_VALUE;
}

// load for: matmul_1x1x1x16x16x16_warps1xstages3
void load_matmul_83ba3f02_0d1d2d3de4de5de6de7c8de9c10de11c();
void load_matmul_1x1x1x16x16x16_warps1xstages3() {
  load_matmul_83ba3f02_0d1d2d3de4de5de6de7c8de9c10de11c();
}

// unload for: matmul_1x1x1x16x16x16_warps1xstages3
void unload_matmul_83ba3f02_0d1d2d3de4de5de6de7c8de9c10de11c();
void unload_matmul_1x1x1x16x16x16_warps1xstages3() {
  unload_matmul_83ba3f02_0d1d2d3de4de5de6de7c8de9c10de11c();
}
...
kernel_func_t matmul_kernels[] = {
  ...
  matmul_1x1x1x16x16x16_warps1xstages3,
};
...
void load_matmul(void){
  ...
  load_matmul_1x1x1x16x16x16_warps1xstages3();
}

void unload_matmul(void){
  unload_matmul_16x16x16_warps1xstages3();
  unload_matmul_1x1x1x16x16x16_warps1xstages3();
}
